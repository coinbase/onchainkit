...
declare function FundButton({ className, disabled, fundingUrl, hideIcon, hideText, openIn, popupSize, rel, target, text: buttonText, }: FundButtonReact): react_jsx_runtime.JSX.Element;
 ...
 * @returns the URL
 */
declare function getCoinbaseSmartWalletFundUrl(): string;
 ...
 * @returns the URL
 */
declare function getOnrampBuyUrl({ projectId, ...props }: GetOnrampUrlWithProjectIdParams | GetOnrampUrlWithSessionTokenParams): string;

export { FundButton, type GetOnrampUrlWithProjectIdParams, type GetOnrampUrlWithSessionTokenParams, getCoinbaseSmartWalletFundUrl, getOnrampBuyUrl };
