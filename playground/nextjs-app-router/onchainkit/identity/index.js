...
// src/identity/components/IdentityCard.tsx
function IdentityCard({ address, chain, className = "", schemaId }) {
  return /* @__PURE__ */ React.createElement(Identity, {
    ...
    schemaId
  }, /* @__PURE__ */ React.createElement(Avatar, null), /* @__PURE__ */ React.createElement(Name, null, /* @__PURE__ */ React.createElement(Badge, null)), /* @__PURE__ */ React.createElement(Address, null), /* @__PURE__ */ React.createElement(Socials, null));
}
__name(IdentityCard, "IdentityCard");

// src/identity/utils/getAddress.ts
import { mainnet as mainnet9 } from "viem/chains";
var getAddress2 = /* @__PURE__ */ __name(async ({ name, chain = mainnet9 }) => {
  const client = getChainPublicClient(chain);
...
var useAddress = /* @__PURE__ */ __name(({ name, chain = mainnet10 }, queryOptions) => {
  const { enabled = true, cacheTime } = queryOptions ?? {};
