...
import { Children, isValidElement as isValidElement2, useCallback, useMemo as useMemo3 } from "react";
...
import { createContext as createContext3, useContext as useContext3, useState } from "react";
var emptyContext2 = {};
var WalletContext = /* @__PURE__ */ createContext3(emptyContext2);
...
__name(WalletProvider, "WalletProvider");
function useWalletContext() {
  return useContext3(WalletContext);
}
...
function ConnectWallet({
  ...
  const { connectWalletText } = useMemo3(() => {
  ...
  const childrenWithoutConnectWalletText = useMemo3(() => {
...
import { Children as Children7, useEffect as useEffect6, useMemo as useMemo10, useRef } from "react";
...
import { Children as Children6, cloneElement as cloneElement2, isValidElement as isValidElement4, useMemo as useMemo9 } from "react";
...
import { Children as Children4, useMemo as useMemo7 } from "react";
...
import { Children as Children2, useMemo as useMemo4 } from "react";
...
function Name({ address = null, className, children, chain, ...props }) {
  ...
  const badge = useMemo6(() => {
    return Children3.toArray(children).find(findComponent(Badge));
  }, [
    children
  ]);
  if (isLoading) {
...
function IdentityLayout({ children, className, onClick }) {
  ...
  const { avatar, name, address, ethBalance, socials } = useMemo7(() => {
...
function useBreakpoints() {
  const [currentBreakpoint, setCurrentBreakpoint] = useState7(void 0);
  useEffect5(() => {
...
import { Children as Children5, cloneElement, isValidElement as isValidElement3, useCallback as useCallback4, useMemo as useMemo8 } from "react";
import { useAccount as useAccount2 } from "wagmi";
function WalletBottomSheet({ children, className }) {
  const { isOpen, setIsOpen } = useWalletContext();
  const { address } = useAccount2();
  const childrenArray = useMemo8(() => {
    return Children5.toArray(children).map((child) => {
      if (/* @__PURE__ */ isValidElement3(child) && child.type === Identity) {
  ...
  const handleOverlayClick = useCallback4(() => {
    setIsOpen(false);
  }, [
    setIsOpen
  ]);
  const handleEscKeyPress = useCallback4((event) => {
    if (event.key === "Escape") {
      setIsOpen(false);
    }
  }, [
...
__name(WalletBottomSheet, "WalletBottomSheet");

// src/wallet/components/WalletDropdown.tsx
function WalletDropdown({ children, className }) {
  const breakpoint = useBreakpoints();
  const { address } = useAccount3();
  const childrenArray = useMemo9(() => {
    return Children6.toArray(children).map((child) => {
      if (/* @__PURE__ */ isValidElement4(child) && child.type === Identity) {
  ...
  if (breakpoint === "sm") {
    return /* @__PURE__ */ React.createElement(WalletBottomSheet, {
      className
    }, children);
  }
  return /* @__PURE__ */ React.createElement("div", {
    className: cn(pressable.default, color.foreground, "absolute right-0 z-10 mt-1 flex w-max min-w-[300px] flex-col overflow-hidden rounded-xl", className),
    "data-testid": "ockWalletDropdown"
  }, childrenArray);
}
__name(WalletDropdown, "WalletDropdown");

// src/wallet/components/Wallet.tsx
var WalletContent = /* @__PURE__ */ __name(({ children, className }) => {
  const { isOpen, setIsOpen } = useWalletContext();
  const walletContainerRef = useRef(null);
  const { connect, dropdown } = useMemo10(() => {
    const childrenArray = Children7.toArray(children);
    return {
  ...
  useEffect6(() => {
    const handleClickOutsideComponent = /* @__PURE__ */ __name((event) => {
...
var Wallet = /* @__PURE__ */ __name(({ children, className }) => {
  const componentTheme = useTheme();
  const isMounted = useIsMounted();
  if (!isMounted) {
    return null;
  }
  return /* @__PURE__ */ React.createElement(WalletProvider, null, /* @__PURE__ */ React.createElement(WalletContent, {
...
// src/wallet/components/WalletDropdownDisconnect.tsx
function WalletDropdownDisconnect({ className, text: text2 = "Disconnect" }) {
  const { disconnect, connectors } = useDisconnect();
  const handleDisconnect = useCallback5(() => {
  ...
  }, disconnectSvg), /* @__PURE__ */ React.createElement("span", {
    className: cn(text.body, "pl-6")
  }, text2));
}
__name(WalletDropdownDisconnect, "WalletDropdownDisconnect");

// src/internal/hooks/useIcon.tsx
import { isValidElement as isValidElement5, useMemo as useMemo11 } from "react";
...
// src/wallet/components/WalletDropdownLink.tsx
function WalletDropdownLink({ children, className, icon: icon2, href, rel, target }) {
...
__name(WalletDropdownLink, "WalletDropdownLink");

// src/wallet/components/WalletDefault.tsx
function WalletDefault() {
  return /* @__PURE__ */ React.createElement(Wallet, null, /* @__PURE__ */ React.createElement(ConnectWallet, null, /* @__PURE__ */ React.createElement(ConnectWalletText, null, "Connect Wallet"), /* @__PURE__ */ React.createElement(Avatar, {
    className: "h-6 w-6"
  }), /* @__PURE__ */ React.createElement(Name, null)), /* @__PURE__ */ React.createElement(WalletDropdown, null, /* @__PURE__ */ React.createElement(Identity, {
    className: "px-4 pt-3 pb-2",
    hasCopyAddressOnClick: true
  }, /* @__PURE__ */ React.createElement(Avatar, null), /* @__PURE__ */ React.createElement(Name, null), /* @__PURE__ */ React.createElement(Address, {
    className: color.foregroundMuted
  }), /* @__PURE__ */ React.createElement(EthBalance, null)), /* @__PURE__ */ React.createElement(WalletDropdownLink, {
    icon: "wallet",
    href: "https://keys.coinbase.com",
    target: "_blank"
  }, "Wallet"), /* @__PURE__ */ React.createElement(WalletDropdownDisconnect, null)));
}
__name(WalletDefault, "WalletDefault");
...
function WalletDropdownBasename({ className }) {
  ...
  return /* @__PURE__ */ React.createElement("a", {
    ...
    className: "-translate-y-1/2 absolute top-1/2 left-4 flex h-[1.125rem] w-[1.125rem] items-center justify-center"
  }, basenameSvg), /* @__PURE__ */ React.createElement("div", {
    className: "flex w-full items-center pl-6"
  }, isLoading ? /* @__PURE__ */ React.createElement(Spinner, null) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", {
    className: cn(text.body)
  }, title), !hasBaseUserName && /* @__PURE__ */ React.createElement("span", {
...
__name(WalletDropdownBasename, "WalletDropdownBasename");
...
function useGetFundingUrl() {
  ...
  const { address, chain: accountChain } = useAccount7();
...
// src/wallet/components/WalletDropdownFundLink.tsx
function WalletDropdownFundLink({ className, fundingUrl, icon: icon2 = "fundWallet", openIn = "popup", popupSize = "md", rel, target, text: text2 = "Fund wallet" }) {
...
__name(WalletDropdownFundLink, "WalletDropdownFundLink");
...
__name(isValidAAEntrypoint, "isValidAAEntrypoint");
...
__name(isWalletACoinbaseSmartWallet, "isWalletACoinbaseSmartWallet");
export {
  ConnectWallet,
  ConnectWalletText,
  Wallet,
