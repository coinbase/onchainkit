      ...
      <div className="flex items-center justify-center">
        <NFTMintCard 
          ...
          useNFTData={() => ({
            ...
            imageUrl: "https://ipfs.io/ipfs/bafybeibozzie5uy6tc2adpklc5rygchjgw5uqrgnmspzzpoveibwpqnbwy",
            mimeType: "image/png"
          })}
        >
          <NFTCollectionTitle/>
  ...
  return (
    <App>
      <NFTMintCard 
        ...
        useNFTData={() => ({
          name: "Videos",
          animationUrl: "https://ipfs.io/ipfs/bafybeigg7e2m2ubmntg4z7uvqzatpnkxs6w5celjky5o32uakskkrwyqpi",
          mimeType: "video/mp4"
        })}
      >
