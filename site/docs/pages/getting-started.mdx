...
#### Obtain an Public API Key from the [Coinbase Developer Platform APIs](https://portal.cdp.coinbase.com/products/onchainkit).
...
Set your API key by assigning the value you copied from the Coinbase Developer Platform to the `ONCHAINKIT_API_KEY` variable.
