...
<img
  ...
  src="https://onchainkit.xyz/assets/onchainkit-components-paymaster-endpoint.png"
  width="auto"
/>
```tsx
// ommited for brevity
      ...
      if (address) {
        return (
          <Transaction 
            ...
            capabilities={{
              paymasterService: {
                url: 'https://api.developer.coinbase.com/rpc/v1/base/KkgONfLFgUZKI8nnrttLbI78U2vyhtXg',
              },
            }}
          >
            <TransactionButton />
