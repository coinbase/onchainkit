...
<App>
  <SwapWrapper>
    {({ address, swappableTokens }) => {
      if (address) {
        return (
          <Swap address={address} className={"bg-fuchsia-500"}>
            <SwapAmountInput
              label="Sell"
            ...
            />
            <SwapToggleButton className={"bg-fuchsia-500"}/>
            <SwapAmountInput
              label="Buy"
              swappableTokens={swappableTokens}
              ...
              className={"bg-fuchsia-500"}
            />
            <SwapButton className={"bg-fuchsia-500"}/>
            <SwapMessage className={"bg-fuchsia-500"} />
          </Swap>
        )
      }
