...
```tsx [code]
import { buildSwapTransaction } from '@coinbase/onchainkit/swap';
...
[`Promise<BuildSwapTransactionResponse>`](/swap/types#buildswaptransactionresponse)

## Parameters

[`BuildSwapTransactionParams`](/swap/types#buildswaptransactionparams)
