...
```
      ...
      <div className='flex grow items-center justify-center md:h-auto'>
        <App>
          <WalletDemo />
        </App>
      </div>
    ...
    <div className="flex flex-col md:flex-row md:items-end justify-between">
      <div className="flex flex-col justify-between xl:flex-row xl:space-x-[25px]">
        <div className="pt-[20px] xl:pt-[40px]">
          ...
          <a href="/getting-started" className="mx-auto md:mx-0 flex justify-center items-center bg-indigo-400 text-[#030712] font-bold leading-6 px-4 py-3 rounded-xl w-[180px]">
            Get started
          </a>
        </div>
      </div>
