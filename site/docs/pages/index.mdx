...
:::
      ...
      <a href="/getting-started" title="Get started with OnchainKit" className="alternate-button mx-auto md:mx-0 flex justify-center items-center bg-indigo-600 hover:bg-indigo-700 text-zinc-50 dark:bg-indigo-400 dark:text-zinc-950 dark:hover:bg-indigo-300 font-semibold leading-6 px-3 py-2 rounded-lg w-[140px]">
        Get started
      </a>
    </div>
  </div>
...
<main className="items-center flex flex-col vp-doc relative">
  <div className="live-demo-sectionpt-12">
    <ComponentPreview />
  </div>
  <div className="testimonials-section pt-12 overflow-x-auto">
    <Tweets />
  </div>
