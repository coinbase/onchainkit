...
<div className="max-w-screen-xl mx-auto vp-doc relative px-[24px] mb-[26px] mt-0 md:px-0 md:mb-[64px]">
  <div className="mx-auto max-w-2xl">
    <div className="md:text-center flex flex-col gap-8 pt-48 pb-16">
      <h1 className="text-center text-9xl font-medium no-underline dark:text-white">OnchainKit</h1>
      <div className="text-center text-3xl dark:text-white leading-none">
        <p className="leading-none">React components
...
<section>
  <main className="flex flex-col items-center gap-4 md:flex-row">
    ...
    <p className="basis-1/2 text-2xl md:px-36">Let's build frames on Base</p>
  </main>
...
<section>
  <main className="flex flex-col items-center gap-4 md:flex-row">
    <h2 className="basis-1/2 text-6xl ">Helping builders ship faster</h2>
  </main>
