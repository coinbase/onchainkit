...
<section className="w-[1225px] max-w-full pt-[56px] px-1 md:px-0">
  ...
  <aside className="pb-6">
    ...
    <a href="/identity/address" className="mx-auto md:m-0 flex justify-center items-center border border-indigo-400 text-indigo-400 font-bold leading-6 px-4 py-3 rounded-xl border-solid w-[180px]">
      Start with Identity
    </a>
