  ...
  <div className="overflow-x-scroll flex flex-col gap-4 py-10 md:flex-row min-w-[32px]">
    {[
      ...
      <div className="flex flex-col gap-4 py-10 md:flex-col" key={text}>
        ...
        <a href={link} className="text-center w-32 font-sans border rounded-xl border-solid border-white px-3 py-2 font-bold no-underline">
          View docs
        </a>
      </div>
    ))}
...
<section>
  <main className="flex flex-col gap-4 md:flex-row">
    <h2 className="basis-1/2 py-10 text-4xl md:text-6xl font-normal">Components</h2>
  </main>
  <aside className="md:px-2">
...
<section>
  <main className="flex flex-row gap-1">
    <h2 className="basis-1/2 text-4xl md:text-6xl font-normal">Utilities</h2>
  </main>
...
<section>
  <main className="flex flex-col gap-4 md:flex-row">
    <h2 className="basis-1/2 text-4xl md:text-6xl font-normal">Design</h2>
  </main>
  <p className="py-2 text-lg md:text-xl">
...
<section>
  <main className="flex flex-col gap-4 md:flex-row">
    <h2 className="basis-1/2 text-4xl md:text-6xl font-normal">
