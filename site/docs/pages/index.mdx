...
<WalletComponents>
  ...
  <main id="tokens" className="pt-[56px] flex flex-col gap-4 md:flex-row md:text-left text-center">
    <a href="#tokens" title="Tokens Component details">
...
<div className="flex flex-col gap-4 rounded-3xl bg-ock-inverse p-4">
  ...
  {filteredTokens.length > 0 ? (
    <div>
      <div className="text-body text-black dark:text-white">Tokens</div>
      <div>
        {filteredTokens.map((token) => (
            ...
            if (address) {
              return (
                <Transaction
                  ...
                  onSuccess={onSuccess}
                >
                <TransactionButton className="w-[240px] px-4 py-2 text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors" />
                  <TransactionSponsor />
                  <TransactionStatus>
                    <TransactionStatusLabel />
                    <TransactionStatusAction />
    ...
    <div className="flex flex-col md:flex-row md:items-end justify-between">
      ...
      <div className="flex flex-col md:flex-row items-center md:space-x-[128px]">
        <ul className="flex space-x-[28px] py-3 md:py-0">
          ...
          <li>[Template](https://github.com/Zizzamia/an-onchain-app-in-100-components)</li>
        ...
        <ul className="social-icons-list flex space-x-[28px]">
          ...
          <a href="https://discord.gg/8gW3h6w5" title="View OnchainKit discord" target="_blank">
