    ...
    <div className="md:text-center flex flex-col gap-8 pt-48 pb-16" >
      ...
      <div className="text-center text-xl md:text-3xl dark:text-white">
        <p className="leading-7 md:leading-none">
          Ship your onchain apps in minutes with out-of-the box React
          components and TypeScript utilities.
        </p>
      </div>
    </div>
...
:::
      ...
      <a href="/getting-started" target="_blank" className="font-sans justify-self-end border rounded-xl border-solid border-white px-4 py-3 font-bold">
        View docs 
