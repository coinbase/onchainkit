...
:::
      ...
      <a href="/getting-started" title="Get started with OnchainKit" className="alternate-button mx-auto md:mx-0 flex justify-center items-center bg-indigo-600 hover:bg-indigo-700 text-[white] dark:bg-indigo-400 dark:text-black dark:hover:bg-indigo-300 font-bold leading-6 px-3 py-2 rounded-xl w-[140px]">
        Get started
      </a>
    </div>
  </div>
            ...
            if (address) {
              return (
                <Transaction
                  ...
                  onSuccess={onSuccess}
                >
                <TransactionButton className="px-6"/>
                  <TransactionSponsor />
                  <TransactionStatus>
                    <TransactionStatusLabel />
                    <TransactionStatusAction />
