...
<div className="flex flex-col md:flex-row justify-between items-center md:mb-[64px] mx-auto max-w-[1225px] z-10 pt-[100px]">
  <div className="flex flex-col gap-4 md:flex-row">
    <h3 className="py-[15px] md:w-[365px] text-4xl md:text-4xl">Ready-to-use onchain components</h3>
  </div>
...
<main className="css-main-container items-center flex flex-col mx-auto vp-doc relative px-0 mb-[26px] mt-0 md:mb-[64px]">
...
<section className="css-dark-container w-full flex flex-col items-center py-24">
  <div className="w-[1225px] max-w-full flex flex-col justify-between">
    <div className="flex justify-between items-center pb-[20px]">
      <div>
        <h3 className="basis-1/2 py-[15px] text-4xl md:text-4xl">From design to development</h3>
      </div>
...
<section className="css-dark-container w-full flex items-center justify-center">
...
<section className="css-dark-container w-full flex flex-col items-center py-24 gap-[72px]">
  <div>
