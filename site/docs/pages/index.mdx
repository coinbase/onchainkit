...
:::
      ...
      <a href="/getting-started" className="font-sans justify-self-end border rounded-xl border-solid border-white px-3 py-2 font-bold">
        View docs 
      </a>
    </div>
...
{' '}
<section>
  <main className="flex flex-col gap-3 md:flex-row space-y-[25px] font-normal">
    <h2 className="basis-1/2 py-10 text-4xl md:text-5xl">Everything you need to build onchain</h2>
    <aside className="md:px-2">
      <p className="text-lg md:text-2xl py-4 w-[515px] shrink-0 font-normal text-[color:var(--gray-40,#89909E)]">
        OnchainKit offers kits packed with React components and TypeScript utilities ready for action. 
      </p>
    </aside>
  </main>
  <div className="overflow-x-scroll flex flex-col gap-4 py-10 md:flex-row min-w-[32px]">
    {[
      { alt: "OnchainKit index frame", src: "assets/onchainkit-frame-1.png", text: "Frame", link: "/frame/frame-metadata" },
      { alt: "OnchainKit identity frame", src: "assets/onchainkit-identity-2.png", text: "Identity", link: "/identity/introduction" },
      { alt: "OnchainKit wallet frame", src: "assets/onchainkit-wallet-3.png", text: "Wallet", link: "/wallet/introduction" },
      { alt: "OnchainKit tokens frame", src: "assets/onchainkit-tokens-2.png", text: "Tokens", link: "/token/introduction" },
      { alt: "OnchainKit swap frame", src: "assets/onchainkit-swap-1.png", text: "Swap", link: "/swap/swap" },
    ].map(({ alt, src, text, link }) => (
      <div className="flex flex-col gap-4 py-10 md:flex-col" key={text}>
        <img className="min-w-80 rounded-3xl" alt={alt} src={src} />
        <p className="text-4xl md:text-2xl h-9 font-normal">{text}</p>
        <a href={link} className="text-center w-32 font-sans border rounded-xl border-solid border-white px-3 py-2 font-bold">
          View docs
        </a>
      </div>
    ))}
...
{/* <section>
  <main className="flex flex-col gap-3 md:flex-row space-y-[25px] font-normal">
    ...
    <div className="overflow-x-scroll flex flex-col gap-4 py-10 md:flex-row min-w-[32px]">
      <div className="flex flex-col gap-4 py-10 md:flex-col">
        <img className="min-w-80 rounded-3xl"
          alt="OnchainKit index frame"
          src="assets/onchainkit-frame-1.png"
        />
        <p className="text-4xl md:text-2xl h-9 font-normal">
          Frame
        </p>
        <a href="/frame/frame-metadata" className="text-center w-32 font-sans border rounded-xl border-solid border-white px-3 py-2 font-bold">
          View docs 
        </a>
      </div>
      <div className="flex flex-col gap-4 py-10 md:flex-col">
        <img className="min-w-80 rounded-3xl"
          alt="OnchainKit identity frame"
          src="assets/onchainkit-identity-2.png"
        />
        <p className="text-4xl md:text-2xl h-9 font-normal">
          Identity
        </p>
        <a href="/identity/introduction" className="text-center w-32 font-sans border rounded-xl border-solid border-white px-3 py-2 font-bold">
          View docs 
        </a>
      </div>
      <div className="flex flex-col gap-4 py-10 md:flex-col">
        <img className="min-w-80 rounded-3xl"
          alt="OnchainKit wallet frame"
          src="assets/onchainkit-wallet-3.png"
        />
        <p className="text-4xl md:text-2xl h-9 font-normal">
          Wallet
        </p>
        <a href="/wallet/introduction" className="text-center w-32 font-sans border rounded-xl border-solid border-white px-3 py-2 font-bold">
          View docs 
        </a>
      </div>
      <div className="flex flex-col gap-4 py-10 md:flex-col">
        <img className="min-w-80 rounded-3xl"
          alt="OnchainKit tokens frame"
          src="assets/onchainkit-tokens-2.png"
        />
        <p className="text-4xl md:text-2xl h-9 font-normal">
          Tokens
        </p>
        <a href="/token/introduction" className="text-center w-32 font-sans border rounded-xl border-solid border-white px-3 py-2 font-bold">
          View docs 
        </a>
      </div>
      <div className="flex flex-col gap-4 py-10 md:flex-col">
        <img className="min-w-80 rounded-3xl"
          alt="OnchainKit swap frame"
          src="assets/onchainkit-swap-1.png"
        />
        <p className="text-4xl md:text-2xl h-9 font-normal">
          Swap
        </p>
        <a href="/swap/swap" className="text-center w-32 font-sans border rounded-xl border-solid border-white px-3 py-2 font-bold">
          View docs 
        </a>
      </div>
    </div>
...
<section>
  <main className="flex flex-col gap-4 md:flex-row font-normal">
...
<section>
  <main className="flex flex-row gap-1 font-normal">
  ...
  <footer className="flex flex-col justify-center space-y-[25px]">
    <div className="flex max-w-[1400px] flex-col justify-between xl:flex-row xl:space-x-[25px]">
      <div className="space-y-[20px] xl:space-y-[40px]">
        <h2 className="text-4xl md:text-9xl font-normal">OnchainKit</h2>
      </div>
