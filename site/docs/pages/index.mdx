...
<section className="css-alternate-container w-full flex flex-col items-center py-24 gap-[72px]">
  ...
  <div className="flex flex-col md:flex-row gap-6">
    <div className="max-w-[438px]">
      <img src="/assets/onchain-tweet-1.png" width="438" loading="lazy" />
    </div>
    <div className="flex flex-col max-w-[648px] gap-6">
      <img src="/assets/onchain-tweet-2.png" width="648" loading="lazy" />
      <img src="/assets/onchain-tweet-3.png" width="648" loading="lazy" />
    </div>
  </div>
