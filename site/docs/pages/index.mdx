...
<div className="flex flex-col md:flex-row justify-between items-center md:mb-[64px] mx-auto max-w-[1225px] z-10 pt-[100px]">
  <div className="flex flex-col gap-4 md:flex-row">
    <h3 className="py-[15px] md:w-[365px] text-4xl md:text-4xl text-gray-50">Ready-to-use onchain components</h3>
  </div>
  <div className="flex gap-12 max-w-full flex-wrap justify-center md:justify-end">
...
<main className="items-center flex flex-col mx-auto vp-doc relative px-0 mb-[26px] mt-0 md:mb-[64px] bg-gray-900">

{' '}

<section className="w-[1225px] max-w-full pt-[56px]">
  <main id="identity" className="flex flex-col gap-4 md:flex-row">
  ...
  <aside className="pb-6">
    ...
    <div className="flex grow md:flex-row pt-[44px]">
...
```
  ...
  <main id="wallet" className="flex flex-col gap-4 md:flex-row pt-14">
...
```
  ...
  <main id="tokens" className="flex flex-col gap-4 md:flex-row pt-14">
...
<App>
  ...
  <main id="swap" className="flex flex-col gap-4 md:flex-row pt-14" data-testid="swap-content">
...
<section className="bg-[#030713] w-full flex flex-col items-center py-24">
  <div className="w-[1225px] max-w-full flex flex-col justify-between">
    <div className="flex justify-between items-center">
      <div>
        <h3 className="basis-1/2 py-[15px] text-4xl md:text-4xl text-gray-50">From design to development</h3>
      </div>
      <p className="w-[450px] max-w-full text-[#8A919E] text-[28px] font-light leading-9 md:text-[28px]">Take ownership over design or collaborate efficiently with designers</p>
    </div>
    <aside>
      <a href="/swap/swap" className="flex justify-center items-center border border-indigo-400 text-indigo-400 font-bold leading-6 px-4 py-3 rounded-xl border-solid w-[180px]">
        View figma
...
<section>
  <aside className="flex flex-col py-14 md:flex-row md:px-2 w-[940px]">
...
<section className="bg-[#030713] w-full flex flex-col items-center py-24 gap-[72px]">
  <div>
    <h3 className="basis-1/2 py-[15px] text-4xl md:text-4xl text-gray-50 max-w-[525px] text-center">Builders ship faster with OnchainKit</h3>
  </div>
...
<hr className="my-8 md:my-20" />
  ...
  <footer className="flex flex-col justify-center space-y-[25px] max-w-screen-xl w-full">
    <div className="flex items-end justify-between">
      <div className="flex flex-col justify-between xl:flex-row xl:space-x-[25px]">
        <div className="pt-[20px] xl:pt-[40px]">
          ...
          <p className="leading-7 text-xl text-gray-400 px-0 py-6 max-w-[500px]">
            Build your onchain apps with ready-to-use React components and Typescript utilities.
          </p>
          <a href="/getting-started" className="flex justify-center items-center bg-indigo-400 text-[#030712] font-bold leading-6 px-4 py-3 rounded-xl w-[180px]">
            Get started
          </a>
        </div>
      </div>
      <div className="flex flex-row items-center space-x-[128px]">
        <ul className="flex space-x-[28px]">
          ...
          <li>[Playground](https://warpcast.com/~/channel/onchainkit)</li>
          <li>[Template](https://github.com/coinbase/onchainkit)</li>
          <li>[Figma](https://github.com/coinbase/onchainkit)</li>
        </ul>
        <ul className="flex space-x-[28px]">
          ...
          <a href="https://warpcast.com/~/channel/onchainkit">
