...
description: Introduction to Identity Kit
---
...
- [`getEnsAvatar`](/identity/get-ens-avatar): Get avatar image src. (ENS only for now)
...
npm install viem@2.x react@18 react-dom@18 @tanstack/react-query graphql@14 graphql-request@6
```

```bash [yarn]
yarn add @coinbase/onchainkit
yarn add viem@2.x react@18 react-dom@18 @tanstack/react-query graphql@14 graphql-request@6
```
