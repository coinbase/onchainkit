...
```tsx twoslash
// @errors: 2305
import { Socials } from '../src/identity';
import { base } from 'viem/chains';
...
You can override styles using `className` or by setting a custom [OnchainKit theme](/guides/themes#custom-theme). 
You can also set the `mainnet` chain for ENS name resolution:
...
export default function StyledSocials() {
  return (
    <Socials 
      address="0x4bEf0221d6F7Dd0C969fe46a4e9b339a84F52FDF"
