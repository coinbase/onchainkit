...
npm install react@18 react-dom@18 wagmi @tanstack/react-query @coinbase/wallet-sdk
```

```bash [yarn]
yarn add @coinbase/onchainkit
yarn add react@18 react-dom@18 wagmi @tanstack/react-query @coinbase/wallet-sdk
```

```bash [pnpm]
pnpm add @coinbase/onchainkit
pnpm add react@18 react-dom@18 wagmi @tanstack/react-query @coinbase/wallet-sdk
```
