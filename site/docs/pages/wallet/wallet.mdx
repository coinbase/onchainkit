...
<OnchainKitProvider
  ...
  config={{
    ...
    wallet: {
      display: 'modal',             // Use modal display mode
...
- **Multiple Wallet Options**: Users can choose between Coinbase Wallet and other wallets via WalletConnect
- **Smart Wallet Support**: Configure Coinbase Wallet connector with `preference: 'all'` to support both smart wallets and EOA wallets
- **Customizable Appearance**: Configure the modal's appearance through the `OnchainKitProvider`'s config
- **Terms & Privacy**: Add links to your terms of service and privacy policy
- **Responsive Design**: Works seamlessly on both desktop and mobile devices

The wallet modal will automatically handle the connection flow, presenting users with options to:
- Sign up for a new wallet
- Connect with Coinbase Wallet
- Connect with other wallets via WalletConnect

This provides a streamlined, user-friendly experience for connecting wallets while maintaining full customization control through the `OnchainKitProvider` configuration.
