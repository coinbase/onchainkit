...
To customize the name and logo of your application, set `appName` and `appLogoUrl` inside your Wagmi configuration.
Also ensure that your Wagmi configuration is set to `smartWalletOnly` and supports Base.
...
export function getConfig() {
  return createConfig({
    ...
    connectors: [
      coinbaseWallet({
        appName: "OnchainKit", // [!code ++]
        appLogoUrl: "https://onchainkit.xyz/favicon/48x48.png?v4-19-24", // [!code ++]
        preference: 'smartWalletOnly', // [!code ++]
        version: '4',
      }),
    ],
