...
Before using the `FundCard` component, ensure you've completed the [Getting Started](/getting-started) steps.
...
`FundCard` will work out of the box when you implement the component in your own app.
:::
