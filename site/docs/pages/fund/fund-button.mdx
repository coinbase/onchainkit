...
The `<FundButton />` components provides a way for users to fund their wallet without leaving your app. It automatically
detects the type of wallet your user has connected and directs them to the appropriate funding URL.
