...
<div className="mx-44">
    <img src="/assets/onchainkit-overview.png" />
</div>

<div className="w-10/12 mx-20 mt-20">
     <h1 className="pt-4 pb-4 text-lg font-bold text-zinc-950 mx-36">
...
<div className="w-10/12 mx-20 mt-20">
    ...
    <div className="flex space-x-6 items-center justify-center mt-4 mx-36">
...
<div className="px-6 py-4 bg-gray-50 rounded-xl mx-56">
