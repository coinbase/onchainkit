...
```bash [npm]
npm install @coinbase/onchainkit @xmtp/frames-validator viem@^2 wagmi@^2 @tanstack/react-query@^5
```

```bash [yarn]
yarn add @coinbase/onchainkit @xmtp/frames-validator viem@^2 wagmi@^2 @tanstack/react-query@^5
```

```bash [pnpm]
pnpm add @coinbase/onchainkit @xmtp/frames-validator viem@^2 wagmi@^2 @tanstack/react-query@^5
```

```bash [bun]
bun add @coinbase/onchainkit @xmtp/frames-validator viem@^2 wagmi@^2 @tanstack/react-query@^5
```
