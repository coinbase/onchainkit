...
This is an authenticated endpoint and we recommend creating charges server-side following the Coinbase Commerce [Quickstart](https://docs.cdp.coinbase.com/commerce-onchain/docs/quickstart) guide.
:::
