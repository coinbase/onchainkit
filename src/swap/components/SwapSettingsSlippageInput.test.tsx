...
describe('SwapSettingsSlippageInput', () => {
  ...
  it('applies correct styles in Auto mode', () => {
    ...
    expect(screen.getByRole('button', { name: 'Auto' })).toHaveClass(
      'cursor-pointer ock-bg-default active:ock-bg-default-active hover:bg-[var(--ock-bg-default-hover)] ock-text-foreground ock-font-family font-semibold text-sm leading-5 ock-border-radius-inner flex-1 px-3 py-1 transition-colors ock-bg-inverse ock-text-primary ock-shadow-default',
    );
    expect(screen.getByRole('button', { name: 'Custom' })).toHaveClass(
      'cursor-pointer ock-bg-default active:ock-bg-default-active hover:bg-[var(--ock-bg-default-hover)] ock-text-foreground ock-font-family font-semibold text-sm leading-5 ock-border-radius-inner flex-1 px-3 py-1 transition-colors ock-text-foreground-muted',
    );
