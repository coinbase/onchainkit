...
export { WalletBasic } from './components/WalletBasic';
...
export { WalletIsland } from './components/island/WalletIsland';
export { WalletIslandDefault } from './components/island/WalletIslandDefault';
