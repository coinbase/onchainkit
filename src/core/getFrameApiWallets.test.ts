import { getFrameApiWallets } from './getFrameApiWallets';

describe('getFrameApiWallets', () => {
  ...
  it('should return undefined if no apiKey is passed', () => {
    ...
    const result = getFrameApiWallets({});
  ...
  it('should return wallet addresses if the request is successful', async () => {
    ...
    const result = await getFrameApiWallets({ apiKey: 'test-api-key' });
