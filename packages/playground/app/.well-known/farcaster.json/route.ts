export async function GET() {
  return Response.json({
    ...
    frame: {
      ...
      iconUrl: 'http://onchainkit.xyz/playground/snake.png',
      imageUrl: 'http://onchainkit.xyz/playground/snake.png',
      buttonTitle: 'Launch MiniKit',
      splashImageUrl: 'http://onchainkit.xyz/playground/snake.png',
