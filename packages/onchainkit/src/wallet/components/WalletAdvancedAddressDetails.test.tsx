...
import { OnchainKitProvider } from '@/onchainkit/components/OnchainKitProvider';
...
vi.mock('@/onchainkit/hooks/useOnchainKit', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('@/onchainkit/hooks/useOnchainKit')>();
  return {
    ...actual,
