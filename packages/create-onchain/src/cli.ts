...
function logMiniKitSetupSummary(
  ...
  console.log(
    pc.blue(
      "\n* Don't forget to update the environment variables for your project in the `.env` file. Including your Redis credentials to enable background notifications and personalized high scores.",
    ),
  );
}
